  ...
  , loadMeting = function() {
    function a(a, t) {
        ...
        if (t.length) {
            ...
            for (var s in e) {
                var n = s.toLowerCase();
                (a.dataset.hasOwnProperty(n) || a.dataset.hasOwnProperty(s) || null !== e[s]) && (r[s] = a.dataset[n] || a.dataset[s] || e[s],
    ...
    for (var r = document.querySelectorAll(".aplayer"), s = 0; s < r.length; s++) {
        (function() {
            var e = r[s];
            if (e.classList.contains("no-reload"))
                return "continue";
            if (e.classList.contains("no-destroy") && e.classList.add("no-reload"),
            e.dataset.id) {
